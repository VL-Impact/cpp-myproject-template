...
//  std::cout << "SQlite3 version " << SQLITE_VERSION << std::endl;
    ...
    try
    {
        ...
        /*********************/
        SQLite::Statement   query2(db, "INSERT INTO test VALUES (NULL, :my_txt)");
        std::cout << "INSERT INTO test VALUES (NULL, :my_txt) :\n";
        query2.bind(":my_txt", "test");
        std::cout << "\t" << query2.exec() <<std::endl;
        query2.reset();    
        query2.bind(":my_txt", "test");
        std::cout << "\t" << query2.exec() <<std::endl;  
        query2.reset();  
